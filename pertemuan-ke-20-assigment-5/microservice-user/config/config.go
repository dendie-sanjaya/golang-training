...
var (
	...
	PostgresStringConnection = getEnv("POSTGRES_STRING_CONNECTION", "postgresql://postgres:password@127.0.0.1:5434/golang_user?sslmode=disable")
	PostgresDB               = getEnv("POSTGRES_DB", "golang_user")
	PostgresUser             = getEnv("POSTGRES_USER", "postgres")
	PostgresPassword         = getEnv("POSTGRES_PASSWORD", "password")
	PostgressPort            = getEnv("POSTGRES_PORT", "5434")
